...
module goocanvas.CanvasPathModel;
 ...
 */
public class CanvasPathModel : CanvasItemModelSimple
{
	/** the main Gtk struct */
	protected GooCanvasPathModel* gooCanvasPathModel;

	/** Get the main Gtk struct */
	public GooCanvasPathModel* getCanvasPathModelStruct()
	{
		return gooCanvasPathModel;
	}

	/** the main Gtk struct as a void* */
	protected override void* getStruct()
	{
		return cast(void*)gooCanvasPathModel;
	}

	protected override void setStruct(GObject* obj)
	{
		gooCanvasPathModel = cast(GooCanvasPathModel*)obj;
		super.setStruct(obj);
	}
	 ...
	 */
	public this (GooCanvasPathModel* gooCanvasPathModel, bool ownedRef = false)
	{
		this.gooCanvasPathModel = gooCanvasPathModel;
		super(cast(GooCanvasItemModelSimple*)gooCanvasPathModel, ownedRef);
	}
