...
module goocanvas.CanvasTable;

private import glib.ConstructionException;
private import gobject.ObjectG;
private import goocanvas.CanvasGroup;
 ...
 */
public class CanvasTable : CanvasGroup
{
	/** the main Gtk struct */
	protected GooCanvasTable* gooCanvasTable;

	/** Get the main Gtk struct */
	public GooCanvasTable* getCanvasTableStruct()
	{
		return gooCanvasTable;
	}

	/** the main Gtk struct as a void* */
	protected override void* getStruct()
	{
		return cast(void*)gooCanvasTable;
	}

	protected override void setStruct(GObject* obj)
	{
		gooCanvasTable = cast(GooCanvasTable*)obj;
		super.setStruct(obj);
	}
	 ...
	 */
	public this (GooCanvasTable* gooCanvasTable, bool ownedRef = false)
	{
		this.gooCanvasTable = gooCanvasTable;
		super(cast(GooCanvasGroup*)gooCanvasTable, ownedRef);
	}
